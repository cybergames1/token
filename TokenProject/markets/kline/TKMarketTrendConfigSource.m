...
#import "TKMarketTrendConfigSource.h"
#import "TKRequest.h"

@implementation TKMarketTrendConfigSource

- (void)requestConfigURL:(NSString *)url success:(void (^)(NSURLSessionDataTask *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *))failure
{
